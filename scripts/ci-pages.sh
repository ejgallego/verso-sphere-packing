...
lake lean SpherePackingBlueprintMain.lean -- --run SpherePackingBlueprintMain.lean --output _out/site 2>&1 | python3 scripts/filter_docstring_warnings.py --project-root .
